...
1. Clone the repository and navigate to the `my-resume` folder
2. Run `npm install` to install dependencies
3. Create a `.env` file in the `my-resume` folder with your EmailJS credentials:
...
5. Submit the form to send an email and see a summary of your submission
